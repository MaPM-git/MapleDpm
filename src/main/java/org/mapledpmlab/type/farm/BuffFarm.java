...
public class BuffFarm extends Common {
    ...
    public BuffFarm() {
        this.setDescription("" +
                ...
                "\n21.쁘띠 루미너스(어둠) : 공격력/마력 5" +
                "\n22.미르 : 공격력/마력 5" +
                "\n23.검은 마법사의 그림자 : 공격력/마력 6" +
                "\n24.쁘띠 루미너스(이퀄리브리엄) : % 미적용 공격력 마력 [LEVEL]/20" +
                "\n25.반반 : 버프 지속시간 5%" +
                "\n26.쁘띠 아카이럼 : 버프 지속시간 5%" +
                "\n27.군단장 윌 : 버프 지속시간 6%" +
        ...
        this.addPlusBuffDuration(5L);   // 반반
        this.addPlusBuffDuration(5L);   // 쁘띠아카이럼
        this.addPlusBuffDuration(6L);   // 군단장윌
        // 쁘띠루미너스(빛)
    }
}
