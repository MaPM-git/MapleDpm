...
public class FinalAttackFarm extends Common {

    public FinalAttackFarm() {
        this.setDescription("" +
                "\n농장" +
                "\n1.주스탯 스페셜 SS : 주스탯 15" +
                "\n2.주스탯 스페셜 A+ : 주스탯 10" +
                ...
                "\n9.검은 바이킹 : 데미지 2%" +
                "\n10.쁘띠 시그너스 : 데미지 3%" +
                "\n11.로맨티스트 킹슬라임 : 크리티컬 확률 3%" +
                "\n12.쁘띠 혼테일 : 크리티컬 확률 3%" +
                "\n13.쁘띠 팬텀 : 크리티컬 확률 4%" +
                "\n14.라즐리 : 크리티컬 확률 5%" +
                "\n15.쁘띠 힐라 : 크리티컬 데미지 2%" +
                "\n16.쁘띠 반레온 : 보스 공격 시 데미지 5%" +
                "\n17.쁘띠 랑 : 보스 공격 시 데미지 8%" +
                "\n18.라피스 : 몬스터 방어율 무시 5%" +
                "\n19.쁘띠 매그너스 : 몬스터 방어율 무시 5%" +
                "\n20.양철 나무꾼 : 몬스터 방어율 무시 6%" +
                "\n21.쁘띠 은월 : 재사용 대기시간 미적용 4%" +
