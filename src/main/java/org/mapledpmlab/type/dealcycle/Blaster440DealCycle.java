...
public class Blaster440DealCycle extends DealCycle {
    // 매그팡
    ...
    public Blaster440DealCycle(Job job) {
        super(job, new FinalAttackBlaster());

        this.getJob().setName("블래스터(440)");
        ...
        DoubleFang150 doubleFang150 = new DoubleFang150();
