...
public class DemonAvenger29ContinuousDealCycle extends DealCycle {
    ...
    public DemonAvenger29ContinuousDealCycle(Job job) {
        super(job, new FinalAttackDemonAvenger());

        getJob().setName("데몬 어벤져(29, 컨티)");
    ...
    public void getJobInfo() {
        ...
        System.out.println("총 HP : " + ((DemonAvengerContinuous) getJob()).getTotalHp());
