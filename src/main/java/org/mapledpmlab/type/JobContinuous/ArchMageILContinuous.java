...
public class ArchMageILContinuous extends Job {

    public ArchMageILContinuous() {
        // 기본
        super();
        this.setName("아크메이지(썬,콜)(컨티)");
        ...
        this.addDamage(50L);            // 앨리먼트 앰플리케이션
    ...
    public void Doping() {
        super.Doping();
        this.addFinalDamage(1.2);            // 익스트림 매직
        this.addDamage(40L);                 // 아케인 에임
    }
