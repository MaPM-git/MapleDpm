...
import org.mapledpmlab.type.skill.buffskill.angelicbuster.GrandFinaleBuff;

public class GrandFinaleFinish extends AttackSkill {
    public GrandFinaleFinish() {
        this.setName("그랜드 피날레(축포의 함성)");
