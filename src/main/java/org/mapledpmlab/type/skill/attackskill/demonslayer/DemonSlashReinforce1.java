...
public class DemonSlashReinforce1 extends GaugeAttackSkill {
    public DemonSlashReinforce1() {
        this.setName("강화 데몬 슬래시(1타)");
        this.setAttackCount(3L);
        this.addFinalDamage(0.9);       // 블루 블러드
        this.setAttackCount(this.getAttackCount() * 2);
        this.setDamage(600.0 + 80);
        ...
        this.setRelatedSkill(new DemonSlashReinforce2());
