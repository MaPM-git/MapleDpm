...
public class WindBreakerContinuousDealCycle extends DealCycle {
    ...
    public WindBreakerContinuousDealCycle(Job job) {
        super(job, null);
        ...
        if (skill instanceof BuffSkill) {
            ...
            if (
                    ...
                    && (
                            ...
                            || skill instanceof CygnusPhalanx
                            || skill instanceof HowlingGale1
                            || skill instanceof HowlingGale2
                            || skill instanceof HowlingGale3
                            || skill instanceof IdleWhimAfterSecond
                            || skill instanceof IdleWhimFirst
                            || skill instanceof PinpointPierce
                            || skill instanceof SongOfHeaven
                            || skill instanceof StoneWind
                            || skill instanceof VortexSphere
                    )
            ) {
