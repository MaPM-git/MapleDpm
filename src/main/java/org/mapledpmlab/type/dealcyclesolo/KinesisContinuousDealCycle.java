...
public class KinesisContinuousDealCycle extends DealCycle {
    ...
    public KinesisContinuousDealCycle(Job job) {
    ...
    public void setSoloDealCycle() {
        ...
        while (getStart().before(getEnd())) {
            if (cooldownCheck(psychicTornado)) {
                isNuke = true;
                if (
