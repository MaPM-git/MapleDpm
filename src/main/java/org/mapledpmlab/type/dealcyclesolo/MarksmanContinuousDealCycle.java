...
public class MarksmanContinuousDealCycle extends DealCycle {
    ...
    public MarksmanContinuousDealCycle(Job job) {
        ...
        if (skill instanceof BuffSkill) {
            ...
            if (
                    ...
                    && (
                            ...
                            || skill instanceof EnhanceSnipeAdditional
                            || skill instanceof Snipe
                            || skill instanceof SplitArrow
    ...
    public void multiAttackProcess(Skill skill) {
        ...
        for (Long info : ((AttackSkill) skill).getMultiAttackInfo()) {
            ...
            if (
                    skill instanceof FinalAimArrow
                            || skill instanceof FinalAimWave
                            || skill instanceof RepeatingCrossbowCartridge
