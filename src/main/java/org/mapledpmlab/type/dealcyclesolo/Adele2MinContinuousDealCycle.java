...
public class Adele2MinContinuousDealCycle extends DealCycle {
    ...
    public Adele2MinContinuousDealCycle(Job job) {
        super(job, null);

        this.setAttackSkillList(attackSkillList);
        this.setBuffSkillList(buffSkillList);

        getJob().setName("아델(컨티, 2분)");
        ...
        getSkillSequence2().add(wrathOfGod);
        getSkillSequence2().add(magicCircuitFullDriveBuff);
        getSkillSequence2().add(bodyOfSteel);
        getSkillSequence2().add(grandisGoddessBlessingLef);

        getSkillSequence3().add(auraWeaponBuff);
        getSkillSequence3().add(restoreBuff);
    }
    ...
    public void setSoloDealCycle() {
        ...
        while (getStart().before(getEnd())) {
            ...
            if (
                ...
                if (cooldownCheck(wrathOfGod)) {
                    addDealCycle(getSkillSequence1());
                } else {
                    restoreBuff.setDelay(450L);
                ...
                isNuke = false;
                    ...
                    && getStart().before(new Timestamp(maestro.getActivateTime().getTime() - 30000))
            ) {
        ...
        if (skill instanceof BuffSkill) {
            ...
            if (
                    ...
                    && (
                            ...
                            || skill instanceof Blossom
                            || skill instanceof BlossomRestore
                            || skill instanceof Creation
                            || skill instanceof Devide
                            || skill instanceof Gathering
                            || skill instanceof GatheringRestore
                            || skill instanceof Grave
                            || skill instanceof Impale
                            || skill instanceof Marker1
                            || skill instanceof Resonance
                            || skill instanceof Ruin
                            || skill instanceof Shard
                            || skill instanceof Squall
    ...
    public void multiAttackProcess(Skill skill) {
        ...
        for (Long info : ((AttackSkill) skill).getMultiAttackInfo()) {
            ...
            if (
                    ...
                    && (
                            skill instanceof DevideReinforce
                            || skill instanceof Maestro
                            || skill instanceof MaestroFinish
                    )
            ) {
                addSkillEvent(continuousRing);
            }
