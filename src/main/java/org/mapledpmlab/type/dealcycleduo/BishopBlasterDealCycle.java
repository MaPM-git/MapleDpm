...
import org.mapledpmlab.type.JobContinuous.BlasterContinuous;
import org.mapledpmlab.type.dealcyclesolo.Bishop2ContinuousDealCycle;
import org.mapledpmlab.type.dealcyclesolo.Blaster510ContinuousDealCycle;
...
public class BishopBlasterDealCycle extends DuoDealCycle {

    public BishopBlasterDealCycle() {
        setName("비숍 + 블래");
        setDescription("비숍(컨티) + 블래(컨티)\n매그팡 딜레이 510ms");

        setDealCycle1(new Bishop2ContinuousDealCycle(new BishopContinuous()));
        setDealCycle2(new Blaster510ContinuousDealCycle(new BlasterContinuous()));
